...
import com.hww.common.constant.ProductConstant;
import com.hww.gulimall.product.dao.AttrAttrgroupRelationDao;
import com.hww.gulimall.product.dao.AttrGroupDao;
...
import com.hww.gulimall.product.dao.AttrDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public void deleteRelation(AttrGroupRelationVo[] vos) {
        ...
        for (AttrAttrgroupRelationEntity entity : entities) {
            ...
            paramMap.put("attr_id",entity.getAttrId());
            paramMap.put("attr_group_id",entity.getAttrGroupId());
            List<AttrAttrgroupRelationEntity> attrAttrgroupRelationEntities = relationDao.selectByMap(paramMap);
            List<Long> collect = attrAttrgroupRelationEntities.stream().map(item -> item.getId()).collect(Collectors.toList());
